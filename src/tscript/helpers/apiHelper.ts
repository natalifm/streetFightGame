...
import {IFightersMockData} from './mockData';
...
async function fakeCallApi(endpoint: string): Promise<unknown> {
...
function getFighterById(endpoint: string): IFightersMockData | undefined {
